...
import org.opennms.features.apilayer.extension.ExtensionRegistry;
...
public class UIExtensionServiceImpl implements UIExtensionService {
    ...
    public UIExtensionServiceImpl(ExtensionRegistry registry) {
        this.extensionRegistry = registry;
    }

    @Override
    public List<String> listExtensions() {
        return new ArrayList<>(extensionRegistry.getExtensionNames());
    }
}
